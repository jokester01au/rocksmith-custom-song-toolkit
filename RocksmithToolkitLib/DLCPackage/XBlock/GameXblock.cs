            ...
            switch (dlcType) {
                case DLCPackageType.Song:
                    foreach (var arrangement in info.Arrangements) {
                        ...
                        entity.Properties.Add(new Property2014() { Name = "LyricArt", Set = new Set() { Value = info.LyricsTex != null ? String.Format(URN_TEMPLATE, TagValue.Image.GetDescription(), TagValue.DDS.GetDescription(), String.Format("lyrics_{0}", dlcName)) : "" } });
